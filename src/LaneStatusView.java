...
//		jp.add( foul );
	...
	public void receiveLaneEvent(Party pty, int theIndex, Bowler playerBowler, int[][] theCumulScore, HashMap theScore, int theFrameNum, int[] theCurScores, int theBall, boolean mechProblem) {
		curBowler.setText( ( (Bowler)playerBowler).getNickName() );
		if ( mechProblem ) {
